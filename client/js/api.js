...
function token() { return localStorage.getItem('foodie_token'); }
...
window.API = {
  ...
  recipes: {
    ...
    rate:           (id, rating)  => patch(`/recipes/${id}/rating`, { rating }),
    updateNotes:    (id, notes)   => patch(`/recipes/${id}/notes`,  { notes }),
  ...
  discover: {
    search:     (params = {}) => get('/discover?' + new URLSearchParams(params)),
    categories: ()            => get('/discover/categories'),
  },
};
